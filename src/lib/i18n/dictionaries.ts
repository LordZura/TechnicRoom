...
const en: UiDictionary = {
  ...
  home: {
    ...
    viewAll: "View all",
    metadataTitle: "Air Conditioners & HVAC Services in Georgia",
    metadataDescription:
      "Professional air conditioner sales, installation, maintenance, and HVAC services in Georgia.",
    ogTitle: "Air Conditioners & HVAC Services in Georgia | Technic Room",
    ogDescription:
      "Professional air conditioner sales, installation, maintenance, and HVAC services in Georgia.",
  },
  products: {
    ...
    intro:
      "Browse dependable heating and cooling systems tailored for residential and commercial spaces.",
  ...
  contact: {
    ...
    submit: "Send message",
    subtitle:
      "Reach our team directly. We'll help you choose the right climate solution for your space.",
    phone: "Phone",
    email: "Email",
    facebook: "Facebook",
...
const ka: UiDictionary = {
  ...
  home: {
    ...
    metadataTitle: "კონდიციონერები და HVAC სერვისები საქართველოში",
    metadataDescription:
      "კონდიციონერების პროფესიონალური გაყიდვა, მონტაჟი, მოვლა და HVAC სერვისები საქართველოში.",
    ogTitle: "კონდიციონერები და HVAC სერვისები საქართველოში | Technic Room",
    ogDescription:
      "კონდიციონერების პროფესიონალური გაყიდვა, მონტაჟი, მოვლა და HVAC სერვისები საქართველოში.",
  },
  products: {
    ...
    intro:
      "დაათვალიერეთ საიმედო გათბობისა და გაგრილების სისტემები საცხოვრებელი და კომერციული სივრცეებისთვის.",
  ...
  admin: {
    ...
    dashboardSubtitle:
      "მართეთ კატალოგის მონაცემები, თარგმანები და გალერეის სურათები ერთ სივრცეში.",
  ...
  contact: {
    ...
    submit: "გაგზავნა",
    subtitle:
      "დაუკავშირდით ჩვენს გუნდს პირდაპირ — დაგეხმარებით თქვენთვის სწორი კლიმატური გადაწყვეტის შერჩევაში.",
    phone: "ტელეფონი",
    email: "ელ-ფოსტა",
    facebook: "ფეისბუქი",
...
async function translateTextAtRuntime(
  text: string,
  locale: Locale
): Promise<string | null> {
...
function ensureRuntimeTranslation(
  path: string,
  locale: Locale,
  fallbackText: string
) {
  ...
  if (
    runtimeTranslationCache.has(cacheKey) ||
    translationRequestsInFlight.has(cacheKey)
  )
    return;
