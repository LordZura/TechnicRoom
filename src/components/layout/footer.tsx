    ...
    <footer className="mt-8 border-t border-brand-line bg-brand-ivory sm:mt-10">
      <div className="tr-shell grid gap-7 py-8 text-sm md:grid-cols-3 md:gap-8 md:py-10">
        <div>
          ...
          <p className="mt-2 text-brand-700/80">Reliable climate solutions with clear technical guidance.</p>
        </div>
        <div>
      ...
      <div className="border-t border-brand-line bg-brand-cream">
        <div className="tr-shell py-3 text-xs text-brand-700/75">© {new Date().getFullYear()} Technic Room. All rights reserved.</div>
      </div>
    </footer>
  );
}
